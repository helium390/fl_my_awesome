...
class OverlayFront extends StatelessWidget {
  ...
  OverlayFront({
    ...
    clippedWidget = DecoratedBox(
        decoration: BoxDecoration(color: overlayColor?.withValues(alpha: .01)));
  }
    ...
    return Stack(children: [
      ...
      Align(
        ...
        child: CustomPaint(
          ...
          child: SizedBox(
            width: (_scanArea?.width ?? standardScanArea.width) + 35.0,
            height: (_scanArea?.height ?? standardScanArea.height) + 35.0,
          ),
        ),
      ),
    ]);
